# Source: https://docs.neurosity.co/docs/guides/training/

[Skip to main content](https://docs.neurosity.co/docs/guides/training/#__docusaurus_skipToContent_fallback)
...
### Time Synchronization [​](https://docs.neurosity.co/docs/guides/training/\#time-synchronization "Direct link to Time Synchronization")
...
### Tagging [​](https://docs.neurosity.co/docs/guides/training/\#tagging "Direct link to Tagging")
...
- [Time Synchronization](https://docs.neurosity.co/docs/guides/training/#time-synchronization)
- [Tagging](https://docs.neurosity.co/docs/guides/training/#tagging)