# Source: https://docs.neurosity.co/docs/tutorials/your-first-web-app/

[Skip to main content](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#__docusaurus_skipToContent_fallback)
...
## Getting Started [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#getting-started "Direct link to Getting Started")
...
## 🔑 Authentication [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#-authentication "Direct link to 🔑 Authentication")
...
## ⚙️ App State [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#%EF%B8%8F-app-state "Direct link to ⚙️ App State")
...
## 🤯 Neurosity SDK [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#-neurosity-sdk "Direct link to 🤯 Neurosity SDK")
...
## 💻 Navigation [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#-navigation "Direct link to 💻 Navigation")
...
## 🧠 Cognitive State [​](https://docs.neurosity.co/docs/tutorials/your-first-web-app/\#-cognitive-state "Direct link to 🧠 Cognitive State")
...
> 💡 Learn more about the [calm score](https://docs.neurosity.co/docs/api/calm).
...
- [Getting Started](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#getting-started)
- [🔑 Authentication](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#-authentication)
- [⚙️ App State](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#%EF%B8%8F-app-state)
- [🤯 Neurosity SDK](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#-neurosity-sdk)
- [💻 Navigation](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#-navigation)
- [🧠 Cognitive State](https://docs.neurosity.co/docs/tutorials/your-first-web-app/#-cognitive-state)