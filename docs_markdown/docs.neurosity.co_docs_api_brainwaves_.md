# Source: https://docs.neurosity.co/docs/api/brainwaves/

[Skip to main content](https://docs.neurosity.co/docs/api/brainwaves/#__docusaurus_skipToContent_fallback)
...
## Sampling Rate [​](https://docs.neurosity.co/docs/api/brainwaves/\#sampling-rate "Direct link to Sampling Rate")
...
## Metrics [​](https://docs.neurosity.co/docs/api/brainwaves/\#metrics "Direct link to Metrics")
...
### Raw [​](https://docs.neurosity.co/docs/api/brainwaves/\#raw "Direct link to Raw")
...
### Raw Unfiltered [​](https://docs.neurosity.co/docs/api/brainwaves/\#raw-unfiltered "Direct link to Raw Unfiltered")
...
### Power Spectral Density (PSD) [​](https://docs.neurosity.co/docs/api/brainwaves/\#power-spectral-density-psd "Direct link to Power Spectral Density (PSD)")
...
### Power by Band [​](https://docs.neurosity.co/docs/api/brainwaves/\#power-by-band "Direct link to Power by Band")
...
- [Sampling Rate](https://docs.neurosity.co/docs/api/brainwaves/#sampling-rate)
- [Metrics](https://docs.neurosity.co/docs/api/brainwaves/#metrics)
  - [Raw](https://docs.neurosity.co/docs/api/brainwaves/#raw)
  - [Raw Unfiltered](https://docs.neurosity.co/docs/api/brainwaves/#raw-unfiltered)
  - [Power Spectral Density (PSD)](https://docs.neurosity.co/docs/api/brainwaves/#power-spectral-density-psd)
  - [Power by Band](https://docs.neurosity.co/docs/api/brainwaves/#power-by-band)