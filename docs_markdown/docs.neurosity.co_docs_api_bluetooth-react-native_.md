# Source: https://docs.neurosity.co/docs/api/bluetooth-react-native/

[Skip to main content](https://docs.neurosity.co/docs/api/bluetooth-react-native/#__docusaurus_skipToContent_fallback)
...
## Bluetooth Connection State [​](https://docs.neurosity.co/docs/api/bluetooth-react-native/\#bluetooth-connection-state "Direct link to Bluetooth Connection State")
...
## Auto Connect [​](https://docs.neurosity.co/docs/api/bluetooth-react-native/\#auto-connect "Direct link to Auto Connect")
...
- [Bluetooth Connection State](https://docs.neurosity.co/docs/api/bluetooth-react-native/#bluetooth-connection-state)
- [Auto Connect](https://docs.neurosity.co/docs/api/bluetooth-react-native/#auto-connect)