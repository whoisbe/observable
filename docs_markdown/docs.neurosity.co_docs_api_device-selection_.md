# Source: https://docs.neurosity.co/docs/api/device-selection/

[Skip to main content](https://docs.neurosity.co/docs/api/device-selection/#__docusaurus_skipToContent_fallback)
...
### Automatic Device Selection [​](https://docs.neurosity.co/docs/api/device-selection/\#automatic-device-selection "Direct link to Automatic Device Selection")
...
### Ahead Of Time Device Selection [​](https://docs.neurosity.co/docs/api/device-selection/\#ahead-of-time-device-selection "Direct link to Ahead Of Time Device Selection")
...
### Manual Device Selection [​](https://docs.neurosity.co/docs/api/device-selection/\#manual-device-selection "Direct link to Manual Device Selection")
...
#### Accessing the list of devices [​](https://docs.neurosity.co/docs/api/device-selection/\#accessing-the-list-of-devices "Direct link to Accessing the list of devices")
...
#### Accessing selected device [​](https://docs.neurosity.co/docs/api/device-selection/\#accessing-selected-device "Direct link to Accessing selected device")
...
### Switching devices [​](https://docs.neurosity.co/docs/api/device-selection/\#switching-devices "Direct link to Switching devices")
...
- [Automatic Device Selection](https://docs.neurosity.co/docs/api/device-selection/#automatic-device-selection)
- [Ahead Of Time Device Selection](https://docs.neurosity.co/docs/api/device-selection/#ahead-of-time-device-selection)
- [Manual Device Selection](https://docs.neurosity.co/docs/api/device-selection/#manual-device-selection)
- [Switching devices](https://docs.neurosity.co/docs/api/device-selection/#switching-devices)