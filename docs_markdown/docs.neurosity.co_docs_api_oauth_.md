# Source: https://docs.neurosity.co/docs/api/oauth/

[Skip to main content](https://docs.neurosity.co/docs/api/oauth/#__docusaurus_skipToContent_fallback)

On this page

## Registering your app [​](https://docs.neurosity.co/docs/api/oauth/\#registering-your-app "Direct link to Registering your app")
...
### Example Project [​](https://docs.neurosity.co/docs/api/oauth/\#example-project "Direct link to Example Project")

The quickest way to implement OAuth is to fork the [example project](https://github.com/neurosity/neurosity-oauth-example).

### OAuth Scopes [​](https://docs.neurosity.co/docs/api/oauth/\#oauth-scopes "Direct link to OAuth Scopes")
...
### Redirect URIs [​](https://docs.neurosity.co/docs/api/oauth/\#redirect-uris "Direct link to Redirect URIs")
...
## Implement Cloud Functions [​](https://docs.neurosity.co/docs/api/oauth/\#implement-cloud-functions "Direct link to Implement Cloud Functions")
...
### First Cloud Function: createOAuthURL [​](https://docs.neurosity.co/docs/api/oauth/\#first-cloud-function-createoauthurl "Direct link to First Cloud Function: createOAuthURL")

The first function wraps the [createOAuthURL](https://docs.neurosity.co/docs/reference/classes/Neurosity#createoauthurl) SDK method. This method creates client-specific OAuth URL. This is the first step of the OAuth workflow. Use this function to create a URL you can use to redirect users to the Neurosity sign-in page.
...
### Second Cloud Function: getOAuthToken [​](https://docs.neurosity.co/docs/api/oauth/\#second-cloud-function-getoauthtoken "Direct link to Second Cloud Function: getOAuthToken")

The [getOAuthToken](https://docs.neurosity.co/docs/reference/classes/Neurosity#getoauthtoken) method retreives the client-specific OAuth token for a given userId.
...
## Integrate to your User Interface [​](https://docs.neurosity.co/docs/api/oauth/\#integrate-to-your-user-interface "Direct link to Integrate to your User Interface")
...
### Add "Connect Neurosity Account" Component [​](https://docs.neurosity.co/docs/api/oauth/\#add-connect-neurosity-account-component "Direct link to Add \"Connect Neurosity Account\" Component")
...
### Manage the Auth state [​](https://docs.neurosity.co/docs/api/oauth/\#manage-the-auth-state "Direct link to Manage the Auth state")
...
### Removing Access [​](https://docs.neurosity.co/docs/api/oauth/\#removing-access "Direct link to Removing Access")

After a user has granted your app access to their Neurosity account, it is good practice to give them the option to remove the access. For that, we'll use the SDK [removeOAuthAccess](https://docs.neurosity.co/docs/reference/classes/Neurosity#removeoauthaccess) method on the client or server side.
...
## Authenticating the Neurosity App [​](https://docs.neurosity.co/docs/api/oauth/\#authenticating-the-neurosity-app "Direct link to Authenticating the Neurosity App")
...
- [Registering your app](https://docs.neurosity.co/docs/api/oauth/#registering-your-app)
  - [Example Project](https://docs.neurosity.co/docs/api/oauth/#example-project)
  - [OAuth Scopes](https://docs.neurosity.co/docs/api/oauth/#oauth-scopes)
  - [Redirect URIs](https://docs.neurosity.co/docs/api/oauth/#redirect-uris)
- [Implement Cloud Functions](https://docs.neurosity.co/docs/api/oauth/#implement-cloud-functions)
  - [First Cloud Function: createOAuthURL](https://docs.neurosity.co/docs/api/oauth/#first-cloud-function-createoauthurl)
  - [Second Cloud Function: getOAuthToken](https://docs.neurosity.co/docs/api/oauth/#second-cloud-function-getoauthtoken)
- [Integrate to your User Interface](https://docs.neurosity.co/docs/api/oauth/#integrate-to-your-user-interface)
  - [Add "Connect Neurosity Account" Component](https://docs.neurosity.co/docs/api/oauth/#add-connect-neurosity-account-component)
  - [Manage the Auth state](https://docs.neurosity.co/docs/api/oauth/#manage-the-auth-state)
  - [Removing Access](https://docs.neurosity.co/docs/api/oauth/#removing-access)
- [Authenticating the Neurosity App](https://docs.neurosity.co/docs/api/oauth/#authenticating-the-neurosity-app)