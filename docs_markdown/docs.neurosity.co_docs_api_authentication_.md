# Source: https://docs.neurosity.co/docs/api/authentication/

[Skip to main content](https://docs.neurosity.co/docs/api/authentication/#__docusaurus_skipToContent_fallback)
...
### Email and Password [​](https://docs.neurosity.co/docs/api/authentication/\#email-and-password "Direct link to Email and Password")
...
### ID Token [​](https://docs.neurosity.co/docs/api/authentication/\#id-token "Direct link to ID Token")
...
- [Email and Password](https://docs.neurosity.co/docs/api/authentication/#email-and-password)
- [ID Token](https://docs.neurosity.co/docs/api/authentication/#id-token)