# Source: https://docs.neurosity.co/docs/api/haptics/

[Skip to main content](https://docs.neurosity.co/docs/api/haptics/#__docusaurus_skipToContent_fallback)
...
![EEG-10-10](https://docs.neurosity.co/img/api/eeg-10-10-dark.png)

**FIG. 1** _International standard for EEG 10-10 channel locations_
...
Figure 1 - EEG 10-10
Seeck M et al. The standardized EEG electrode array of the IFCN. Clin Neurophysiol (2017), [http://dx.doi.org/10.1016/j.clinph.2017.06.254](http://dx.doi.org/10.1016/j.clinph.2017.06.254)